...
//			logger.debug("Loading properties file from:" + location);
	...
	/**
	 * 读取属性文件的key value 保存到map
	 * @param propPath
	 * @return
	 */
	public static Map<String, String> getUpPath(String propPath){
		propPath="db.properties";
		PropertiesLoader propertiesLoader=new PropertiesLoader(propPath);
		String photopath=propertiesLoader.getProperty("photo.path");
		String trmpath=propertiesLoader.getProperty("trm.path");
	...
	public static void main(String[] args) {
		Map<String, String> mappath=getUpPath(null);
		System.out.println("photo-path:"+mappath.get("photo"));
		System.out.println("trm-path:"+mappath.get("trm"));
	}
}
